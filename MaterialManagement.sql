-- we don't know how to generate database MaterialManagement (class Database) :(
...
(
	...
	time_updated datetime2,
	updated_by varchar(50),
	actual_received_date datetime2,
	delivery_date datetime2,
	delivery_no varchar(20),
	delivery_type varchar(255),
	delivery_year varchar(4),
	document_date datetime2,
	header_text varchar(4000),
	issuing_plant varchar(10),
	mode_of_shipment varchar(10),
	no_of_packages int,
	overall_status varchar(10),
	posting_date datetime2,
	receiving_sloc varchar(10),
	ref_dlv_no varchar(30),
	ref_doc_date datetime2,
	ref_doc_no varchar(50),
	ship_to_plant varchar(10),
	vendor_code varchar(10),
	vendor_name nvarchar(140),
	warehouse_user varchar(100),
	code nvarchar(20),
	description nvarchar(255),
	status varchar(25) default 'NEW' not null,
	no_of_scanned_package int constraint t_goods_receipt_no_of_scanned_package_default default 0 not null,
...
create table t_sync_goplus_picking
(
	id varchar(255) not null
		constraint PK__t_sync_g__3213E83FE307158E
			primary key,
	addtl_desc_cn varchar(255),
	addtl_desc_en varchar(255),
	available_qty float,
	...
	delivery_type varchar(255),
	description varchar(255),
	gmc_desc_cn varchar(255),
	gmc_desc_en varchar(255),
	huid varchar(255),
	io_number varchar(255),
	iss_qty float,
	material varchar(255),
	matl_type varchar(255),
	origsrc_gr_item bigint,
	origsrc_gr_no varchar(255),
	origsrc_gr_year varchar(255),
	picking_id varchar(255),
	picking_item bigint,
	picking_no varchar(255),
	picking_year varchar(255),
	pkg_no varchar(255),
	po_doc_no varchar(255),
	rcv_plant varchar(255),
	rcv_sloc varchar(255),
	req_qty float,
	rsv_item bigint,
	rsv_no varchar(255),
	rsv_year varchar(255),
	sloc varchar(255),
...
create table t_shipment_information
(
	id bigint identity
		primary key,
	active bit,
	...
	goods_receipt_id bigint
		constraint FKlmfxq3vgluf0ol644lolqh1c1
			references t_goods_receipt,
	code nvarchar(20),
	description nvarchar(255)
)
go
...
create table t_delivery_information
(
	id bigint identity
		primary key,
	active bit,
	...
	time_updated datetime2,
	updated_by varchar(50),
	addtl_desc varchar(255),
	batch_desc nvarchar(255),
	contact_no varchar(10),
	customs_matl_desc varchar(150),
	customs_matl_type varchar(250),
	delivery_no varchar(20),
	delivery_qty_base decimal(38,4),
	delivery_qty_entry decimal(38,4),
	delivery_qty_order decimal(38,4),
	delivery_year varchar(4),
	dye_lot varchar(5),
	foc_qty_base decimal(38,4),
	foc_qty_entry decimal(38,4),
	gmc_desc varchar(238),
	huid varchar(40),
	io_desc varchar(25),
	io_no varchar(20),
	item int,
	line_no int,
	material varchar(255),
	matl_inv_status varchar(10),
	merch_team varchar(30),
	po_addtl_desc varchar(130),
	po_no varchar(10),
	remarks varchar(1000),
	roll varchar(10),
	storage_description varchar(200),
	storage_location varchar(10),
	uom_base varchar(10),
	uom_entry varchar(10),
	uom_order varchar(10),
	vendor_dye_lot varchar(196),
	goods_receipt_id bigint
		constraint t_delivery_information_t_goods_receipt_id_fk
			references t_goods_receipt,
	code nvarchar(20),
	description nvarchar(255),
	received_by nvarchar(25),
	received_date datetime,
	status varchar(25),
	gross_wt float,
	gross_wt_uom varchar(10),
	net_wt float,
	net_wt_uom varchar(10),
	complete_put_away bit default 0,
	material_type varchar(100),
	join_image varchar(100) constraint join_image_constraint default 't_delivery_information' not null,
	location_id bigint,
	is_created_by_transferred bit,
	deleted bit default 0
)
go

create table t_material_verification
(
	id bigint identity
		constraint t_material_verification_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	time_updated datetime2,
	updated_by varchar(50),
	actual_gw decimal(12,5),
	actual_gw_uom varchar(255),
	actual_qty decimal(38,4),
	actual_qty_uom varchar(255),
	code varchar(255),
	description varchar(255),
	delivery_information_id bigint
		constraint t_material_verification_t_delivery_information_id_fk
			references t_delivery_information,
	put_away_by varchar(30),
	put_away_date datetime,
	location_id bigint,
	status varchar(25),
	converted_qty decimal(38,4),
	converted_uom varchar(10),
	complete_put_away bit default 0
)
go

create unique index t_material_verification_delivery_information_id_uindex
	on t_material_verification (delivery_information_id)
go

create index t_delivery_information_material_index
	on t_delivery_information (material)
go
...
(
	...
	role varchar(255),
	status varchar(255),
	go_shared_from_id int,
	go_username varchar(30),
	go_password nvarchar(30),
	mat_type_access varchar(50)
)
go
...
create table app_user_sbu_plant
(
	id bigint identity
		constraint app_user_sbu_plant_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
...
(
	id bigint identity
		constraint m_storage_location_id_pk
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	tag varchar(255),
	type varchar(255),
	go_plus_sloc_code varchar(255),
	test_decimal decimal(38,4)
)
go
...
(
	...
	updated_by varchar(50),
	role_id bigint
		constraint FKs5gsmyvhmi0nq6f9mg1jtgkh8
...
(
	...
	module_id bigint
		constraint FKp9pwrhlsmyebqa5naxilyswnj
			references fg_references,
	user_role_id bigint
		constraint FK99mpqph1n39atlseip2mxw8o4
			references app_user_roles
)
go
...
create table t_transfer_picking
(
	id bigint identity
		constraint t_transfer_picking_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	updated_by varchar(50),
	batch_desc varchar(255),
	buyer_material_desc varchar(255),
	code varchar(255),
	delivery_information_id varchar(255),
	description varchar(255),
	dye_lot varchar(255),
	io_no varchar(255),
	item int,
	material varchar(255),
	mr_no varchar(255),
	original_available_des_qty float,
	original_available_src_qty float,
	original_io varchar(255),
	original_put_away_des_qty float,
	original_put_away_src_qty float,
	picking_go_plus_id varchar(255),
	picking_no varchar(255),
	picking_year varchar(255),
	put_away_des_id bigint,
	put_away_src_id bigint,
	receiving_io varchar(255),
	roll varchar(10),
	transfer_qty float,
	uom varchar(255),
	location_id bigint,
	vendor_dye_lot varchar(100),
	picking_item int,
	receiving_material varchar(255)
)
go
...
(
	...
	batch_reference_no nvarchar(50),
	prepared_by nvarchar(10),
	prepared_date date,
	fab_desc1 nvarchar(80) not null,
	fab_desc2 nvarchar(80),
	fab_desc3 nvarchar(80),
	sap_material_code nvarchar(20) not null,
	width nvarchar(10),
	weight numeric(10,2),
	bom_supply_code nvarchar(3),
	buyer_id nvarchar(12) not null,
	po_type nvarchar(6),
	season_code nvarchar(5),
	bill_to_code numeric(2),
	uom nvarchar(3) not null,
	exchange_rate numeric(8,4),
	confirmed_currency nvarchar(3) not null,
	confirmed_price numeric(13,2),
	confirmed_terms nvarchar(25),
	overdelivery_tolerance numeric(4,2),
	underdelivery_tolerance numeric(4,2),
	handfeel nvarchar(40),
	shrinkage nvarchar(30),
	color_fastness nvarchar(8),
	to_change nvarchar(8),
	to_stain nvarchar(8),
	crocking_wet nvarchar(8),
	crocking_dry nvarchar(8),
	other_req1 nvarchar(40),
	other_req2 nvarchar(40),
	other_req3 nvarchar(40),
	shipment_sample_requirements nvarchar(40),
	not_ship_before_date nvarchar(8),
	io_no nvarchar(8) not null,
	color nvarchar(240),
	weave_type nvarchar(5),
	order_qty numeric(14,2) not null,
	io_code nvarchar(3),
	vat numeric(7,2),
	factory_code nvarchar(4),
	ship_to_plant nvarchar(4) not null,
	product_month nvarchar(5),
	pack_inst1 nvarchar(78),
	pack_inst2 nvarchar(78),
	pack_inst3 nvarchar(78),
	pack_inst4 nvarchar(78),
	pack_inst5 nvarchar(78),
	pack_inst6 nvarchar(78),
	pack_inst7 nvarchar(78),
	rem1 nvarchar(78),
	rem2 nvarchar(78),
	rem3 nvarchar(78),
	rem4 nvarchar(78),
	...
	rem6 nvarchar(78),
	rem7 nvarchar(78),
	consignee_name nvarchar(30),
	consignee_address1 nvarchar(55),
	consignee_address2 nvarchar(55),
	consignee_country nvarchar(3) not null,
	material_type nvarchar(4),
	base_uom nvarchar(3),
	conversion_factor_base nvarchar(5),
	conversion_factor_order nvarchar(5),
	valid_from nvarchar(8),
	valid_to nvarchar(8),
	not_ship_after_date nvarchar(8),
	io_description nvarchar(40),
	release_no numeric(2),
	discount numeric(7,2),
	shipping_instructions nvarchar(2),
	incoterms nvarchar(3),
	incoterms2 nvarchar(28),
	po_additional_desc nvarchar(68),
	dye_lot nvarchar(3),
	po_line_item_no numeric(5),
	sbu_id int,
	code nvarchar(255),
	description nvarchar(255),
...
create table tmp_inventory_set_no_stocks
(
	id bigint not null,
	put_away_qty decimal(38,9),
	delivery_qty_base decimal(38,4),
	total_picked_qty decimal(38,9),
	total_returned_qty float,
	total_scraped_qty float,
	transferred_qty decimal(38,9) not null,
	status varchar(255),
	available_qty decimal(38,9),
	time_created datetime2
)
go

create table tmp_total_returned_to_update
(
	id bigint identity,
	material varchar(255),
	io_no varchar(255),
	...
	is_transferred bit,
	status varchar(255),
	put_away_qty decimal(38,10),
	total_transact float,
	balance float,
	available_qty decimal(38,10),
	total_scraped_qty float not null,
	total_scraped_qty_hist decimal(38,4) not null,
	total_picked_qty decimal(38,10) not null,
	total_picked_qty_hist decimal(38,10) not null,
	total_returned_qty_hist float not null,
	total_returned_qty float not null,
	sloc_transferred_qty decimal(38,10) not null,
	sloc_transferred_qty_hist decimal(38,7) not null
)
go
...
create table t_put_away_backup_aug_21
(
	id bigint identity,
	active bit,
	created_by varchar(50),
	...
	code varchar(255),
	description varchar(255),
	put_away_by varchar(255),
	put_away_date datetime2,
	put_away_qty decimal(38,10),
	status varchar(255),
	delivery_information_id bigint,
	goods_receipt_id bigint,
	delivery_verification_id bigint,
	location_id bigint,
	converted_qty int,
	converted_uom varchar(10),
	available_qty decimal(38,10),
	total_picked_qty decimal(38,10),
	total_distributed_qty decimal(38,10),
	is_transferred bit,
	transferred_qty decimal(38,10),
	material varchar(255),
	io_no varchar(255),
	roll varchar(255),
	total_scraped_qty float,
	total_returned_qty float,
	deleted bit,
	total_transfer_picking_qty decimal(38,10),
	created_from varchar(255),
	manual_zero_out bit,
	location_transfer_add decimal(38,10),
	location_transfer_deduct decimal(38,10)
)
go
...
(
	...
	tag_no varchar(255),
	iono int,
	vendor_dye_lot nvarchar(255),
	roll_case_no nvarchar(255),
...
create unique index t_stock_take_id_uindex
	on t_stock_take (id)
go

create table t_picking
(
	id bigint identity
		constraint t_picking_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	time_updated datetime2,
	updated_by varchar(50),
	actual_gw decimal(38,8),
	actual_gw_uom varchar(255),
	actual_qty decimal(38,8),
	actual_qty_uom varchar(255),
	code varchar(255),
	description varchar(255),
	picked_by varchar(255),
	picked_date datetime2,
	picked_gw decimal(38,8),
	picked_gw_uom varchar(255),
	picked_qty decimal(38,10),
	picked_qty_uom varchar(255),
	release_by varchar(255),
	release_date datetime2,
	status varchar(25),
	delivery_information_id bigint,
	material_verification_id bigint,
	location_id bigint,
	picking_no varchar(20),
	mr_no varchar(20),
	converted_qty decimal(38,8),
	converted_uom varchar(20),
	picking_qty_base decimal(38,8),
	put_away_id bigint,
	picking_year varchar(255),
	picking_go_plus_id varchar(255),
	picking_item bigint,
	picking_req_qty decimal(38,8)
)
go
...
(
	...
	actual_gw float,
	actual_qty decimal(38,4),
	actual_uom varchar(255),
	code varchar(255),
	description varchar(255),
	discrepancy_ticket_no varchar(255),
	fulfilled_date datetime2,
	pending_qty datetime2,
	seq varchar(255),
	status varchar(255),
	vendor_code varchar(255),
	verified_date datetime2,
	delivery_information_id bigint
		constraint t_discrepancy_t_delivery_information_id_fk
			references t_delivery_information,
	goods_receipt_id bigint,
	converted_qty int,
	converted_uom varchar(10),
	delivery_qty_base int
)
go
...
create table tmp_picking
(
	picking_no nvarchar(max)
)
go
...
create table t_put_away_history
(
	id bigint identity
		constraint t_put_away_history_id_pk
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	code varchar(255),
	description varchar(255),
	qty_from decimal(38,7),
	qty_to decimal(38,7),
	delivery_information_id bigint not null
		constraint t_put_away_history_t_delivery_information_id_fk
			references t_delivery_information,
	put_away_id bigint not null,
	storage_location_id_from bigint not null,
	storage_location_id_to bigint not null,
	goods_receipt_id bigint,
	destination_put_away_id bigint
)
go
...
create table t_discrepancy_movement_history
(
	id bigint identity
		constraint PK__t_discre__3213E83F58B15A12
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	time_updated datetime2,
	updated_by varchar(50),
	actual_gw numeric(19,2),
	actual_qty numeric(19,2),
	actual_uom varchar(255),
	code varchar(255),
	converted_qty numeric(19,2),
	converted_uom varchar(255),
	delivery_qty_base numeric(19,2),
	description varchar(255),
	discrepancy_ticket_no varchar(255),
	seq varchar(255),
	vendor_code varchar(255),
	discrepancy_id bigint
		constraint FKljlfjwn8qkj8puug6m623dojk
			references t_discrepancy,
	status nvarchar(255)
)
go
...
(
	...
	updated_by varchar(50),
	code varchar(255)
		constraint UK_rbnsa99beo6fh9jcchgblnde6
			unique,
	company varchar(20),
	description varchar(255),
	svap varchar(20),
	...
	vap varchar(20),
	building_id bigint
		constraint FKncbiwmakm9bsqjg37geb4sakx
			references m_building
)
go
...
create table t_delivery_information_deleted
(
	id bigint identity,
	active bit,
	created_by varchar(50),
	...
	delivery_qty_base float,
	delivery_qty_entry float,
	delivery_qty_order float,
	delivery_year varchar(4),
	dye_lot varchar(5),
	foc_qty_base float,
	foc_qty_entry float,
	...
	net_wt float,
	net_wt_uom varchar(10),
	complete_put_away bit
)
go

create table mm_scan_logs_history
(
	id bigint identity
		constraint mm_scan_logs_history_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	code varchar(255),
	delivery_information_id bigint
		constraint mm_scan_logs_history_FK
			references t_delivery_information,
	description varchar(255),
	module_id int,
	is_scanned bit,
...
create table t_goplus_picking_status
(
	id bigint identity
		constraint t_goplus_picking_status_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	description varchar(255),
	last_continue_date datetime2,
	last_pause_date datetime2,
	picking_id varchar(255),
	second_duration bigint,
...
create unique index t_goplus_picking_status_picking_id_uindex
	on t_goplus_picking_status (picking_id)
go

create index t_goplus_picking_status_picking_no_index
	on t_goplus_picking_status (picking_no)
go

create table time_scheduled_management
(
	id bigint identity
		constraint time_scheduled_management_PK
			primary key,
	history_time datetime2,
	name_scheduled varchar(255),
	status varchar(255),
	records_total int
)
go

create table app_user_mat_type_insp_access
(
	id bigint identity
		constraint app_user_mat_type_insp_access_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
...
(
	...
	time_updated datetime2,
	updated_by varchar(50),
	alloc_picking varchar(255),
	code varchar(255),
	description varchar(255),
	material varchar(255),
	orig_src_gr_item varchar(255),
	orig_src_gr_no varchar(255),
	picking_go_plus varchar(255),
	picking_item int,
	picking_no varchar(255),
	picking_year varchar(255),
	qty float,
...
create table t_return_picking
(
	id bigint identity
		constraint t_return_picking_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	picking_no varchar(255),
	picking_year varchar(255),
	returned_qty decimal(38,4),
	uom varchar(255),
	location_id bigint,
	material varchar(255),
	roll varchar(100),
	original_available_qty float,
	put_away_id bigint,
	original_put_away_qty float,
	vendor_dye_lot varchar(100),
	picking_item int
)
go

create table t_invetory_to_return_picking
(
	id bigint identity,
	active bit,
	created_by varchar(50),
	...
	code varchar(255),
	description varchar(255),
	material_inv varchar(255),
	io_no_inv varchar(255),
	material_rp varchar(255),
	io_no_rp varchar(255)
)
go

create table t_scrapping
(
	id bigint identity
		constraint t_scrapping_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
...
create table m_storage_location_temp_dev_1
(
	id bigint identity
		constraint m_storage_location_temp_dev_1_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	type varchar(255),
	go_plus_sloc_code varchar(255),
	mm_sloc_code varchar(255)
)
go

create table t_put_away
(
	id bigint identity
		constraint t_put_away_PK
			primary key,
	active bit,
	created_by varchar(50),
	sbu_id bigint not null,
	...
	status varchar(255),
	delivery_information_id bigint
		constraint t_put_away_t_delivery_information_id_fk
			references t_delivery_information,
	goods_receipt_id bigint,
	delivery_verification_id bigint,
	location_id bigint
		constraint t_put_away_FK
			references m_storage_location_temp_dev_1,
	converted_qty int default 0,
	converted_uom varchar(10),
	available_qty decimal(38,10),
	total_picked_qty decimal(38,10),
	total_distributed_qty decimal(38,10),
	is_transferred bit default 0,
	transferred_qty decimal(38,10),
	material varchar(255),
	io_no varchar(255),
	roll varchar(255),
...
CREATE view view_storage_location
as
  select *,  dbo.fn_GetStorageLocationFullname(id) full_name from m_storage_location_temp_dev_1
go

-- dbo.vw_inventory source
...
select
	...
	tpa.time_updated,
	tpa.active,
	tpa.delivery_verification_id,
	roll = convert(int,convert(numeric(12,2), tdi.roll)),
	tdi.material,
	tdi.material_type,
	tdi.io_no,
	tdi.io_desc,
	...
	tdi.dye_lot,
	tdi.uom_base,
	tdi.received_by as shipment_received_by,
	tdi.received_date as shipment_received_date,
	tdi.delivery_qty_entry as shipment_order_qty,
	tdi.gross_wt as shipment_gross_wt,
	tdi.gross_wt_uom as shipment_wt_uom,
	tdi.net_wt,
	tdi.net_wt_uom,
	tdi.po_no,
	tdi.item,
	tdi.line_no,
	tdi.po_addtl_desc,
	tdi.storage_description,
	tdi.matl_inv_status,
	tdi.uom_order,
	tdi.delivery_qty_entry,
	tdi.uom_entry,
	tdi.delivery_qty_base,
	tdi.foc_qty_entry,
	tdi.foc_qty_base,
	tdi.contact_no,
	tdi.customs_matl_type,
	tdi.customs_matl_desc,
	tdi.merch_team,
	tdi.remarks,
	tdi.id as delivery_information_id,
	mp.code as ship_to_plant,
	mp.description as c_name,
	tpa.put_away_qty,
	tpa.put_away_by,
	tpa.put_away_date,
	tpa.total_picked_qty,
	tpa.available_qty,
	tpa.total_distributed_qty,
	tpa.status,
	tpa.location_id,
	dbo.fn_GetStorageLocationFullname_v2(tpa.location_id, 1) as warehouse,
	dbo.fn_GetStorageLocationFullname_v2(tpa.location_id, 0) as storage_location,
	tmv.created_by as material_inspected_by,
	tmv.time_created as material_inspected_date,
	tmv.actual_qty as material_actual_qty,
	tmv.actual_qty_uom as material_actual_qty_uom,
	tgr.receiving_sloc,
	tgr.ref_doc_no,
	tgr.delivery_type,
	tgr.delivery_date,
	tgr.delivery_year as delivery_year_gr,
	tgr.delivery_no as delivery_no_gr,
	tgr.mode_of_shipment,
	tgr.ship_to_plant as ship_to_plant_gr,
	tgr.issuing_plant,
	tgr.vendor_code,
	tgr.vendor_name,
	tgr.header_text,
	tgr.overall_status as overall_status_gr,
	tgr.posting_date as posting_date_gr,
	tgr.document_date as document_date_gr,
	tgr.actual_received_date as actual_received_date_gr,
	tgr.ref_dlv_no,
	tgr.ref_doc_date,
	tgr.no_of_packages,
	tgr.no_of_scanned_package,
	tgr.warehouse_user,
	tgr.id as goods_receipt_id,
	tpa.total_scraped_qty,
	tpa.total_returned_qty,
	vsl.go_plus_sloc_code,
	available_qty_base = case when isnull(tdi.uom_base,'') = isnull(tmv.actual_qty_uom,'') then available_qty else   ROUND( (SELECT case when put_away_qty = 0 then 0 else delivery_qty_base / put_away_qty * available_qty end),5) end
	,isnull(tpa.transferred_qty,0) as transferred_qty,
	count_tag_status = (select top 1 status from t_stock_take where put_away_id = tpa.id order by time_created desc )
from t_put_away tpa
left join t_delivery_information tdi on tpa.delivery_information_id = tdi.id
left join t_material_verification tmv on tdi.id = tmv.delivery_information_id
left join t_goods_receipt tgr on tpa.goods_receipt_id = tgr.id
left join m_plants mp on tgr.ship_to_plant = mp.code
left join view_storage_location vsl on vsl.id = tpa.location_id;
go

CREATE view vw_picking
as
select 
*, 
dbo.fn_GetStorageLocationFullname_v2(location_id, 0) as storage_location,
dbo.fn_GetStorageLocationFullname_v2(location_id, 1) as warehouse from t_picking
go

CREATE view vw_put_away_history
as
select 
*, 
dbo.fn_GetStorageLocationFullname_v2(storage_location_id_from , 0) as storage_location_origin,
dbo.fn_GetStorageLocationFullname_v2(storage_location_id_from, 1) as warehouse_origin,
dbo.fn_GetStorageLocationFullname_v2(storage_location_id_to , 0) as storage_location_transfer,
dbo.fn_GetStorageLocationFullname_v2(storage_location_id_to, 1) as warehouse_transfer
from t_put_away_history
go

CREATE view vw_return_picking
as
select
	ts.id, ts.active, ts.created_by, ts.sbu_id,
	ts.time_created, ts.time_updated, ts.updated_by, ts.batch_desc, ts.buyer_material_desc,
	ts.code, ts.description, ts.dye_lot, ts.io_no, ts.item, ts.mr_no, ts.picking_go_plus_id,
	ts.picking_no, ts.picking_year, ts.returned_qty, ts.uom, ts.location_id, ts.material,
	--ts.roll,
	roll = convert(int,convert(numeric(12,2), ts.roll)),
	ts.original_available_qty, ts.put_away_id, ts.original_put_away_qty,
	ts.picking_item,
	dbo.fn_GetStorageLocationFullname_v2(ts.location_id, 0) as storage_location,
	dbo.fn_GetStorageLocationFullname_v2(ts.location_id, 1) as warehouse,
	tdi.addtl_desc as mr_des,
	tdi.gmc_desc as mr_gmc_des,
	tdi.batch_desc as mr_batch_des,
	tdi.vendor_dye_lot,
	--tdi.roll as mr_roll,
	mr_roll = convert(int,convert(numeric(12,2), tdi.roll)),
	tdi.material_type,
	tdi.location_id as mr_sloc_id,
	tdi.storage_description as mr_sloc_des,
	dbo.fn_GetStorageLocationFullname_v2(tdi.location_id, 0) as mr_sloc
from t_return_picking ts
left join t_put_away tpa on ts.put_away_id = tpa.id
left join t_delivery_information tdi on tpa.delivery_information_id = tdi.id
go

CREATE view vw_scrapping
as
select
	ts.id, ts.active, ts.created_by, ts.sbu_id, ts.time_created, ts.time_updated, ts.updated_by, ts.batch_desc, ts.buyer_material_desc, ts.code,
	ts.description, ts.dye_lot, ts.io_no, ts.item, ts.material, ts.mr_no, ts.picking_go_plus_id, ts.picking_no, ts.picking_year,
	--ts.roll,
	roll = convert(int,convert(numeric(12,2), ts.roll)),
	ts.scrapping_qty,
	ts.uom, ts.location_id, ts.original_available_qty, ts.put_away_id, ts.original_put_away_qty,  picking_item = ts.pick_item,
	dbo.fn_GetStorageLocationFullname_v2(ts.location_id, 0) as storage_location,
	dbo.fn_GetStorageLocationFullname_v2(ts.location_id, 1) as warehouse,
	tdi.addtl_desc as mr_des,
	tdi.gmc_desc as mr_gmc_des,
...
CREATE view vw_goods_receipt
as
select
	tgr_main.*,
	(case when tmp.not_yet_put_away_num > 0 then 0 else 1 end) as is_put_away_all,
	(case when tmp.num_zero_actual_qty_item > 0 then 1 else 0 end) as is_containing_zero_actual_qty_item,
	dbo.fn_GetStorageLocationFullname_v2(tgr_main.location_id,
	0) as storage_location,
	dbo.fn_GetStorageLocationFullname_v2(tgr_main.location_id,
	1) as warehouse
from
	t_goods_receipt tgr_main
join
(
	select
		tgr.id,
		--sum(case when tmv.id is null or tmv.complete_put_away = 0 then 1 else 0 end) as not_yet_put_away_num,
		sum(case when tmv.complete_put_away = 1 then 0 when tmv.status = 'INSPECTED' and tmv.actual_qty = 0 then 0 else 1 end) as not_yet_put_away_num,
		sum(case when tmv.actual_qty = 0 then 1 else 0 end) as num_zero_actual_qty_item
	from
		t_goods_receipt tgr
	left join t_delivery_information tdi on
		tgr.id = tdi.goods_receipt_id
	left join t_material_verification tmv on
		tmv.delivery_information_id = tdi.id
	group by
		tgr.id
) tmp on
	tmp.id = tgr_main.id
...
CREATE view view_filter
as
SELECT
(1) as id,
	SUBSTRING(
(
     SELECT ',' + delivery_no AS 'data()'
         FROM (SELECT DISTINCT tgr.delivery_no FROM t_goods_receipt (nolock ) tgr  ) tgr FOR XML PATH('')
), 2 , 9999999) as delivery_no,
	SUBSTRING(
(
     SELECT ',' + io_no AS 'data()'
         FROM (SELECT DISTINCT tdi.io_no FROM t_delivery_information (nolock ) tdi) tgr FOR XML PATH('')
), 2 , 9999999) as io_no,
	SUBSTRING(
(
     SELECT ',' + po_no AS 'data()'
         FROM (SELECT DISTINCT tdi.po_no FROM t_delivery_information tdi (nolock ) ) tgr FOR XML PATH('')
), 2 , 9999999) as po_no,
	SUBSTRING(
(
     SELECT ',' + material AS 'data()'
         FROM (SELECT DISTINCT tdi.material FROM t_delivery_information tdi (nolock ) ) tgr FOR XML PATH('')
), 2 , 9999999) as material,
	SUBSTRING(
(
     SELECT ',' + ref_dlv_no AS 'data()'
         FROM (SELECT DISTINCT tgr.ref_dlv_no FROM t_goods_receipt tgr (nolock ) ) tgr FOR XML PATH('')
), 2 , 9999999) as ref_dlv_no,
	SUBSTRING(
(
     SELECT ',' + huid AS 'data()'
         FROM (SELECT DISTINCT tdi.huid FROM t_delivery_information tdi (nolock ) ) tgr FOR XML PATH('')
), 2 , 9999999) as huid,
	SUBSTRING(
(
     SELECT ',' + delivery_type AS 'data()'
         FROM (SELECT DISTINCT tgr.delivery_type FROM t_goods_receipt tgr where status != 'RETURNED') tgr FOR XML PATH('')
), 2 , 9999999) as delivery_type,
SUBSTRING(
(
     SELECT (case when vendor_dye_lot = '' then '' else ',' + vendor_dye_lot end) AS 'data()'
         FROM (SELECT DISTINCT tdi.vendor_dye_lot FROM t_delivery_information (nolock ) tdi) tgr FOR XML PATH('')
), 2 , 9999999) as vendor_dye_lot,

STUFF(( SELECT DISTINCT ',' + picking_no FROM t_picking (nolock ) FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 1, '') AS picking_no,
STUFF(( SELECT DISTINCT ',' + mr_no FROM t_picking (nolock ) FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 1, '') AS mr_no,

STUFF(( SELECT DISTINCT ',' + picking_no FROM t_transfer_picking (nolock ) FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 1, '') AS transfer_picking_no,
STUFF(( SELECT DISTINCT ',' + mr_no FROM t_transfer_picking (nolock ) FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 1, '') AS transfer_picking_mr_no,

STUFF(( SELECT DISTINCT ',' + picking_no FROM t_scrapping (nolock ) FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 1, '') AS scrapping_picking_no,
STUFF(( SELECT DISTINCT ',' + mr_no FROM t_scrapping (nolock ) FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 1, '') AS scrapping_mr_no,

STUFF(( SELECT DISTINCT ',' + picking_no FROM t_return_picking (nolock ) FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 1, '') AS return_picking_no,
STUFF(( SELECT DISTINCT ',' + mr_no FROM t_return_picking (nolock ) FOR XML PATH(''), TYPE).value('.', 'NVARCHAR(MAX)'), 1, 1, '') AS return_mr_no
go

CREATE view vw_transfer_picking
as
select
  id,
  active                     ,
  ...
  material                   ,
  mr_no                      ,
  original_available_des_qty ,
  original_available_src_qty ,
  original_io                ,
  original_put_away_des_qty  ,
  original_put_away_src_qty  ,
  picking_go_plus_id         ,
  picking_no                 ,
  picking_year               ,
  put_away_des_id            ,
  put_away_src_id            ,
  receiving_io               ,
  roll = convert(int,convert(numeric(12,2), roll)),                     
  transfer_qty               ,
  uom                        ,
  location_id                ,
  vendor_dye_lot             ,
  ...
  receiving_material,
  dbo.fn_GetStorageLocationFullname_v2(location_id, 0) as storage_location,
  dbo.fn_GetStorageLocationFullname_v2(location_id, 1) as warehouse
from t_transfer_picking
go

CREATE view vw_delivery_information
as
select tdi.* from t_delivery_information tdi
left join t_material_verification tmv on tdi.id = tmv.delivery_information_id
where ((tmv.id is null and tdi.status = 'INSPECTED') or tmv.complete_put_away = 0) and (tdi.is_created_by_transferred is null or tdi.is_created_by_transferred = 0)
go

CREATE view vw_transfer_location
AS
  select a.io_no, a.material, a.gmc_desc, a.batch_desc,
    dye_lot,
    vendor_dye_lot,
    original_location = b.storage_location_origin,
    transferred_location = b.storage_location_transfer,
    --roll_case_no = a.roll,
    roll = convert(int,convert(numeric(12,2), a.roll)),
    transferred_qty = b.qty_to, uom = a.uom_base, plant_code = ship_to_plant, a.delivery_no, delivery_year,
    ref_dlv_no, po_no, po_line  = a.line_no, a.huid,
    receiving_sloc, transferred_by = b.created_by, transferred_date = b.time_created, b.id, a.id as put_away_id,
    a.ref_doc_no, a.addtl_desc,
    b.sbu_id, b.active, b.updated_by, b.time_updated, b.created_by, b.time_created, b.code, b.description
  from vw_inventory a
    inner join vw_put_away_history b on a.delivery_information_id = b.delivery_information_id and a.id = b.put_away_id
go
...
--vw_po_carton Item Summary : 'PO23Q2TC00307'
	...
	FROM (
		SELECT a.pono, a.iono, style_code as  style_no,  c.carton_no, c.carton_qty, packing_issued, warehouse_rcv,
			picked_for_loading, scan_load
		from FGWarehouse.dbo.fg_purchase_order (nolock) a
		inner join FGWarehouse.dbo.fg_purchase_order_dtl (nolock) b on a.id =b.purchase_order_id
		inner join FGWarehouse.dbo.fg_carton (nolock) c on c.purchase_order_dtl_id = b.id
		--where  a.pono in (:pono)
	) aa
	group by aa.pono, aa.iono, aa.style_no
go

create view vw_distinct_huid
as
    select huid, vendor_dye_lot, status from t_delivery_information where status = 'CREATED'
go

CREATE view vw_loading_plan_summary
as
--vw_po_carton Item Summary : 'PO23Q2TC00307'
	SELECT aa.sbu_id, aa.active, aa.loading_plan_no , aa.pono, aa.iono, aa.style_no,
		count(aa.carton_no) as  total_cartons,
		sum(carton_qty) as total_qty,
		sum(case when packing_issued = 1 then 1 else 0 end) issued_cartons,
		sum(case when packing_issued = 1 then carton_qty else 0 end) issued_qty,
	...
	FROM (
		SELECT a.sbu_id, a.active, a.pono, a.iono, style_code as  style_no,  c.carton_no, c.carton_qty, packing_issued, warehouse_rcv,
			picked_for_loading, scan_load, e.loading_plan_no, f.status
		from FGWarehouse.dbo.fg_purchase_order (nolock) a
		inner join FGWarehouse.dbo.fg_purchase_order_dtl (nolock) b on a.id =b.purchase_order_id
		inner join FGWarehouse.dbo.fg_carton (nolock) c on c.purchase_order_dtl_id = b.id
		inner join FGWarehouse.dbo.fg_loading_plan_pl d on d.purchase_order_dtl_id = b.id
		inner join FGWarehouse.dbo.fg_loading_plan e on e.id = d.loading_plan_id and e.id = c.loading_plan_id
		LEFT join FGWarehouse.dbo.fg_loading_plan_container f on f.loading_plan_id = e.id
-- 		where
			--a.pono in ('POC22Q4TC1000268') and
-- 		a.sbu_id = 1--:sbuId
-- 		and a.active = 1--:active
	) aa
	group by aa.pono, aa.iono, aa.style_no, aa.loading_plan_no, aa.status, aa.sbu_id, aa.active
go

CREATE VIEW vw_scan_logs_history AS
	select a.id, e.module, e.id as module_id, tdi.id as delivery_information_id, tdi.delivery_no, tdi.material,
		a.created_by as scanned_by, isnull(a.is_scanned,0) as is_scanned, a.sbu_id, a.active, a.time_created, a.scan_mode
	from mm_scan_logs_history a with (nolock)
	inner join t_delivery_information tdi with (nolock) on tdi.id = a.delivery_information_id 
	inner join (select id, description as module from fg_references where ref_type = 'APP_MODULES') e on e.id = a.module_id
go

CREATE view view_inventory_by_sloc
as
  select a.sbu_id, a.id, b.description as sloc, sum(put_away_qty) as put_away_qty --, available_qty, total_distributed_qty,total_picked_qty, transferred_qty, is_transferred
  from MaterialManagement.dbo.t_put_away a
  inner join m_storage_location b on a.location_id = b.id
  group by a.id, b.description,  a.sbu_id
go

CREATE FUNCTION [dbo].[fn_GetStorageLocationFullname] (@id integer)
RETURNS varchar(255) AS
BEGIN
  declare @code varchar(255)
  declare @fullcode varchar(255)
  declare @RecID integer
  declare @ParentRecID integer

  begin
    select @code=rtrim(ltrim(code)), @ParentRecID=parent_rec_id from m_storage_location_temp_dev_1 with(Nolock) where id=@id
    set @fullcode = @code
    while @ParentRecID is not null
    begin
          select @code=rtrim(ltrim(code)), @ParentRecID=parent_rec_id from m_storage_location_temp_dev_1 with(Nolock) where id=@ParentRecID
          set @fullcode = @code + ' - ' + @fullcode
    end
  end
...
CREATE FUNCTION [dbo].[fn_GetStorageLocationFullname_v2] (@id integer, @isGetWareHouse bit = 0)
RETURNS varchar(255) AS
BEGIN
  declare @code varchar(255)
  declare @fullcode varchar(255)
  ...
  begin
    ...
    while @ParentRecID is not null
    begin
          select @code=rtrim(ltrim(code)), @ParentRecID=parent_rec_id, @tag=tag from m_storage_location_temp_dev_1 with(Nolock) where id=@ParentRecID
          if @tag = 'WAREHOUSE'
          BEGIN
	          	set @warehouse = @code
	          	BREAK;
